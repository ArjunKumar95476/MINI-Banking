...
<title>//historydeposite//</title>
</head>
<body>
<%

 String account_number=(String)session.getAttribute("account_number");;
 String transaction_type=(String)session.getAttribute("transaction_type_debit");;
 String amount=(String)session.getAttribute("amountdeposit");;
